...
public class CreateItem extends loginbase{
...
//		        {
    ...
    public void VerifyItem()throws Exception  {
		...
		Assert.assertEquals(Typedropdown, selectedTypedropdown1,errormessage2);
		...
		Assert.assertEquals(statusdropdown, SelectedStatusdropdown1,errormessage3);
