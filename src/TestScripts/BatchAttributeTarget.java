...
public class BatchAttributeTarget extends loginbase{
	   ...
	   //Scrolling to Attribute list
	    ...
	    //Entering value in Name
	     ...
	     //Selecting value from type dropdown
	      WebElement dropdown11 = Attributepom.Attributelisttype(driver);
	      dropdown11.sendKeys(Attritype);
	      dropdown11.sendKeys(Keys.ENTER);
...
//		    Recipepom.Recipeparentsectiontype(driver).sendKeys(childtype);
    ...
    public void createParameter()throws Exception  {
      ...
      //Scroll to Parameter sections 	
        ...
        WebElement effective11 = driver.findElement(By.xpath("//form/div[2]/ul/li[3]/div/div/div/div[3]/ejs-datepicker/div/input"));
        List<WebElement> input11 = driver.findElements(By.tagName("input"));

        for (WebElement input1 : input11) {
            ((JavascriptExecutor) driver).executeScript(
                        "arguments[0].removeAttribute('readonly','readonly')",input1);
        }
        effective11.clear();
        effective11.sendKeys(EffectiveDate);
      ...
      Parameterpom.Parametersectionsversionstart(driver).sendKeys("1");
       ...
       //Clicking on attribute section in recipe
         ...
         Parameterpom.Parametersections(driver).click();
         Parameterpom.ParameterTagsclick(driver).click();
//         driver.findElement(By.xpath("//app-tags/div[1]")).click();
//         Thread.sleep(6000);
    
         
         //Clicking on 'Save' button  WebElement button = 
...
//         js.executeScript("arguments[0].click();", button);
    ...
    public void createbatch()throws Exception  {
      ...
      // GET CELL
        ...
        System.out.println("Assigned To: "+assignedto);
        	...
        	Batchespom.Batchesselectbatchattributerecipevalue(driver).click();
	...
	@Test(priority=6)
    public void batchAttributeverify()throws Exception  {
		
		
		//Clicking on lock icon in dataEntry screen
		Batchespom.Dataentrylockicon(driver).click();
		
		//Navigating to Attribute tab
		Batchespom.Batchattributesectionclick(driver).click();
		
		 //Clicking on '+' button 
		Batchespom.Batchattributeplusclick(driver).click();
     
        //Entering the value in dropdown feild
        Batchespom.Batchattributedropdown(driver).sendKeys(caption);
        Thread.sleep(5000);
        
         WebElement attributeget = Batchespom.Batchattributedropdownselect(driver);
      ...
      //Close the Batch section
		WebElement closeadd = Batchespom.BatchsectionCrossclick(driver);
		JavascriptExecutor executor = (JavascriptExecutor) driver;
		executor.executeScript("arguments[0].click();", closeadd);
		Thread.sleep(1000);
		...
		try
		   {
	        ...
	        System.out.println("Total Row:  " + rowcount1);
	         ...
	         //   st.executeUpdate("delete from attributedata where attributeid=(select attributeid from attribute where attributename="+"'"+Attriname+"'");
	            
	            //Deleting Attribute List
	            System.out.println("deleting attribute list");
	            st.executeUpdate("delete from attribute where attributegroupid=(select attributegroupid from attributegroup where attributegroupname="+"'"+Attributename+"')");
	            
	            //Deleting Attribute Group
	            st.executeUpdate("delete from attributegroup where attributegroupname="+"'"+Attributename+"'");
	            ...
	            //Deleting parameter section
	  			...
	  			//Delete Recipe section
	  					st.executeUpdate("delete from recipesection where recipeid=(select recipeid from recipe where recipename=" +"'"+recipename+"')");
